...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('educational_activities')->insert([
            ['subject_id' => 1, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 1, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 2, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 2, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 3, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 3, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 4, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 4, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 5, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 5, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 6, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 6, 'type' => 'Prednáška', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 1, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 1, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 2, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 2, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 3, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 3, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 4, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 4, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 5, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 5, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 6, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            ['subject_id' => 6, 'type' => 'Cvičenie', 'duration' => 110, 'repetition' => 'každý týždeň'],
            // Ďalšie záznamy...
        ]);
        ...
        DB::table('schedules')->insert([
            ...
            ['educational_activity_id' => 2, 'room_id' => 1, 'instructor_id' => 3, 'day' => 'Ut','start_time' => '08:00:00', 'end_time' => '09:50:00'],
